...
fpr10=[]
F1=[]
with open ("3Validation.txt", "r") as f:
    reader = csv.reader(f, delimiter = "\t")
    for i in reader:
      tpr1_1.append((float(i[0])))
      fpr1_1.append((1.0-float(i[1])))
      #tpr1_2.append((float(i[2])))
##      fpr1_2.append((1.0-float(i[3])))
      #F1.append((float(i[3])))"""
...
##plt.plot(fpr1_2,tpr1_2,label= 'Simple Network Integration = %0.2f' % auc1_2,color='blue', linewidth=3)
plt.plot(fpr1_1,tpr1_1,label='Probabilistic Integrated Associated Network = %0.2f' % auc1_1,color='purple', linewidth=2)
