...
ax10 = data.plot(kind='scatter', x='MC', y='GDAs score', color='c',ax=axes[1][1])
ax11 = data.plot(kind='scatter', x='HEL', y='GDAs score', color='#4D59AB',ax=axes[0][1])
ax12 = data.plot(kind='scatter', x='LTP', y='GDAs score', color='r',ax=axes[1][2])
ax13 = data.plot(kind='scatter', x='OMIM', y='GDAs score', color='#3D59AC', ax=axes[0][2])
ax14 = data.plot(kind='scatter', x='UniProt', y='GDAs score', color='#BC3333', ax=axes[1][0])
ax15 = data.plot(kind='scatter', x='MG', y='GDAs score', color='m', ax=axes[0][0])"""



sns.heatmap(data[["OMIM", "UniProt", "MC","HEL", "MG", "LTP", "GDAs"]].corr(), annot = True, fmt='.2g',cmap= 'coolwarm',vmin=0, vmax=1)
