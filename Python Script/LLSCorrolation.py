...
ax3 = data.plot(kind='scatter', x='OMIM_GS', y='UniProt_GS', color='b',label="OMIM&&MG", ax=axes[0][0])
ax5 = data.plot(kind='scatter', x='OMIM_GS', y='HEL_GS', color='m',label="OMIM&&HEL", ax=axes[0][1])
...
ax9 = data.plot(kind='scatter', x='UniProt_GS', y='HEL_GS', color='#76EE00',label="UniProt&&HEL", ax=axes[1][1])
ax10 = data.plot(kind='scatter', x='HEL_GS', y='LTP_GS', color='c',label="MC&&LTP",ax=axes[1][0])
#ax11 = data.plot(kind='scatter', x='MC_GS', y='HEL_GS', color='#3D59AC',label="MC&&HEL", ax=ax1)
#ax12 = data.plot(kind='scatter', x='HEL_GS', y='LTP_GS', color='#BC3333',label="LTP&&HEL", ax=ax1)
