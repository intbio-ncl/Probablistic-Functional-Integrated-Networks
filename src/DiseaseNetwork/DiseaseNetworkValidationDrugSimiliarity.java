 ...
 */
public class DiseaseNetworkValidationDrugSimiliarity {
  public void NetworkValidat(HashMap<Pair,Integer>DrugSimilarityNetwork)throws IOException {
    ...
    List<Double> scores;
     ...
     double[] scoresToPLot= new double[2000];
        for(Pair u: DrugSimilarityNetwork.keySet()){
           goldStandard.add(u);
