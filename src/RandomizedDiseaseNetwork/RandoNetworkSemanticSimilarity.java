 ...
 */
public class RandoNetworkSemanticSimilarity {

public void semanticsimilarity()throws IOException{
...
System.out.print("number of disease in DO"+DiseaseinDO.size()+"\n");
     ...
     for(int i=0;i<100;i++){
        HashMap<String,Set<String>>DCL=DC.clusters("outRandom"+i);
 ...
 //System.out.print(newDCL.keySet().size());
  ...
  PrintWriter out = null;
        try {
            String outFileName = "UMLStoDOID"+i;
