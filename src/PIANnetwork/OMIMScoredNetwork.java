...
//}
        ...
        System.out.print("size of omim datasets"+diseasegeneassociation.size()+"\t"+Gene.size()+"\t"+ Disease.size()+"\n");
        return OMIMdataset;
    }
    ...
    public Set<Pair>OMIMtoUML(Set<Pair>OMIM)throws IOException{
       ...
       //Map<String,String>OMIMtoUMLS=conversion.OMIMtoUMLS();
        ...
        System.out.print("Mapped omim"+MappedOMIM.size()+"\t"+MappedGene.size()+"\t"+MappedDisease.size()+"\n");
