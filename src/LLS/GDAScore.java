...
public class GDAScore {
    ...
    public void colorrationbetweenscore()throws IOException{
       ...
       PIAN network=new PIAN();
        ...
        Map<Pair,Double>networkOMIM= omim.produceOmimNetwork();
              ...
              try {
                    ...
                    out1.append("DGAS"+"\t"+"EL"+"\n");
                     for(Pair p:networkEL.keySet()){
                         if(networkEL.containsKey(p)&&NetworkS.containsKey(p)&&GDAScore.containsKey(p)
                                 &&NetworkUni.containsKey(p)&&networkMG.containsKey(p)&&NetworkOverlap.containsKey(p)&&networkOMIM.containsKey(p)){
